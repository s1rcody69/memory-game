...
export const WinModal = ({
  moves, score, elapsedTime, difficulty,
  streak, currentUser, onPlayAgain, onViewLeaderboard,
}) => {
  const isStreakMilestone = currentUser && streak > 0 && [3, 7, 14, 30].includes(streak);
  ...
  return (
    <div className="modal-overlay" role="dialog" aria-modal="true">
      <div className="modal win-modal">
        ...
        <span className="win-modal__icon">🏆</span>
        ...
        {currentUser
          ...
          : <p className="win-modal__guest-note">Sign in to save scores &amp; track your streak!</p>
        }
